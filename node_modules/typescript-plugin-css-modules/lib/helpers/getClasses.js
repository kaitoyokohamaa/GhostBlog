    ...
    try {
        ...
        if (options.customRenderer) {
            ...
            transformedCss_1 = sass_1.default
                .renderSync(__assign({ file: fileName, indentedSyntax: fileType === "sass" /* sass */, includePaths: __spreadArrays([filePath, 'node_modules'], (includePaths || [])), importer: importers }, sassOptions))
                .css.toString();
        }
